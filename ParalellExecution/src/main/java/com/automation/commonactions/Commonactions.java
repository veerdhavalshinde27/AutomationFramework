 ...
 * 
 */
package com.automation.commonactions;
...
public class Commonactions extends Base {
	...
	/**
	 * Author : Gaurav Description : Clicking the invisible(Hidden) Elements
	 *
	 * @param driver
	 * @param element
	 * @return
	...
	/**
	 * Author : Gaurav Description : Waiting for an Element until it is visible
	 *
	 * @param driver
	 * @param element
	 * @return
	...
	public void dropDownValues(WebDriver driver, WebElement element) {
		Actions act = new Actions(driver);
	...
	public void dropDownsValues(WebDriver driver, WebElement element) {
		Actions act = new Actions(driver);
	...
	public void escapeKeyWord(WebDriver driver, WebElement element) {
